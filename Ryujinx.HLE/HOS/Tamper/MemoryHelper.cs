...
namespace Ryujinx.HLE.HOS.Tamper
{
    class MemoryHelper
    {
        public static ulong GetAddressShift(MemoryRegion source, CompilationContext context)
        {
            ...
            {
                MemoryRegion.NSO   => context.ExeAddress,   // Memory address is relative to the code start.
                MemoryRegion.Heap  => context.HeapAddress,  // Memory address is relative to the heap.
                MemoryRegion.Alias => context.AliasAddress, // Memory address is relative to the alias region.
                MemoryRegion.Asrl  => context.AslrAddress,  // Memory address is relative to the asrl region, which matches the code region.
