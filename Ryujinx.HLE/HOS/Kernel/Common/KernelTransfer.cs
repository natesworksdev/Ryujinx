...
namespace Ryujinx.HLE.HOS.Kernel.Common
{
    static class KernelTransfer
    {
        ...
        public static bool KernelToUserInt32(KernelContext context, ulong address, int value)  => KernelToUser(context, address, value);
        public static bool KernelToUserInt64(KernelContext context, ulong address, long value) => KernelToUser(context, address, value);

        public static bool KernelToUser<T>(KernelContext context, ulong address, T value) where T : unmanaged
        {
            KProcess currentProcess = context.Scheduler.GetCurrentProcess();
