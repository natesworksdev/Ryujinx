...
namespace Ryujinx.HLE.HOS.Services.Am.AppletAE.AllSystemAppletProxiesService.SystemAppletProxy
{
    class ISelfController : IpcService
    {
        ...
        public ResultCode SetScreenShotPermission(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { screenShotPermission });
        ...
        public ResultCode SetOperationModeChangedNotification(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { operationModeChangedNotification });
        ...
        public ResultCode SetPerformanceModeChangedNotification(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { performanceModeChangedNotification });
        ...
        public ResultCode SetFocusHandlingMode(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { unknownFlag1, unknownFlag2, unknownFlag3 });
        ...
        public ResultCode SetRestartMessageEnabled(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { restartMessageEnabled });
        ...
        public ResultCode SetOutOfFocusSuspendingEnabled(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { outOfFocusSuspendingEnabled });
        ...
        public ResultCode SetScreenShotImageOrientation(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { screenShotImageOrientation });
        ...
        public ResultCode SetHandlesRequestToDisplay(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { handlesRequestToDisplay });
        ...
        public ResultCode SetIdleTimeDetectionExtension(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { idleTimeDetectionExtension });
        ...
        public ResultCode GetIdleTimeDetectionExtension(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceAm, new { _idleTimeDetectionExtension });
