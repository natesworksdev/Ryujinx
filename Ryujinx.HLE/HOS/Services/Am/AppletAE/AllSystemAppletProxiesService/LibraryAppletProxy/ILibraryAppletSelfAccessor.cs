...
namespace Ryujinx.HLE.HOS.Services.Am.AppletAE.AllSystemAppletProxiesService.LibraryAppletProxy
{
    class ILibraryAppletSelfAccessor : IpcService
    {
        ...
        {
            if (context.Device.Processes.ActiveProcess.Informations.ProgramId == 0x0100000000001009)
            {
                // Create MiiEdit data.
            ...
            {
                throw new NotImplementedException($"{context.Device.Processes.ActiveProcess.Informations.ProgramId} applet is not implemented.");
            }
        }
