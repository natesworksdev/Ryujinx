...
namespace Ryujinx.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy
{
    class IApplicationFunctions : IpcService
    {
        ...
        public ResultCode EnsureSaveData(ServiceCtx context)
        {
            ...
            ApplicationId applicationId = new ApplicationId(context.Device.Processes.ActiveProcess.Informations.ProgramId & ~0xFul);
        ...
        public ResultCode GetDesiredLanguage(ServiceCtx context)
        {
            ...
            int  supportedLanguages  = (int)context.Device.Processes.ActiveProcess.Informations.ApplicationControlProperties.SupportedLanguageFlag;
        ...
        public ResultCode GetDisplayVersion(ServiceCtx context)
        {
            ...
            context.ResponseData.Write(context.Device.Processes.ActiveProcess.Informations.ApplicationControlProperties.DisplayVersion);
