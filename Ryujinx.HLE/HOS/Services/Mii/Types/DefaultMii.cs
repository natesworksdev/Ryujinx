...
namespace Ryujinx.HLE.HOS.Services.Mii.Types
{
    ...
    struct DefaultMii
    {
        ...
        public static int TableLength => FromIndex.Length;

        private static readonly int[] FromIndex = new int[] { 2, 3, 4, 5, 6, 7 };

        public static DefaultMii GetDefaultMii(uint index)
        {
            return Table[FromIndex[index]];
        }

        #region "Raw Table Array"
        private static ReadOnlySpan<byte> TableRawArray => new byte[1728]
        {
