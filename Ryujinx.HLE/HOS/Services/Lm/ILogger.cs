    ...
    class Logger : IpcService
    {
        ...
        public long Log(ServiceCtx context)
        {
            ...
            using (MemoryStream ms = new MemoryStream(logBuffer))
            {
                ...
                {
                    case LmLogLevel.Trace:    Common.Logging.Logger.PrintDebug  (LogClass.ServiceLm, text); break;
                    case LmLogLevel.Info:     Common.Logging.Logger.PrintInfo   (LogClass.ServiceLm, text); break;
                    case LmLogLevel.Warning:  Common.Logging.Logger.PrintWarning(LogClass.ServiceLm, text); break;
                    case LmLogLevel.Error:    Common.Logging.Logger.PrintError  (LogClass.ServiceLm, text); break;
                    case LmLogLevel.Critical: Common.Logging.Logger.PrintError  (LogClass.ServiceLm, text); break;
                }
            }
