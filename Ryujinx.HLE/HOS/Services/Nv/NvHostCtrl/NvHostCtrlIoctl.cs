...
namespace Ryujinx.HLE.HOS.Services.Nv.NvHostCtrl
{
    ...
    {
        private static ConcurrentDictionary<Process, NvHostCtrlUserCtx> _userCtxs;
        ...
        {
            return SyncptReadMinOrMax(context, false);
        }
        ...
        {
            return EventWait(context, false);
        }

        private static int EventWaitAsync(ServiceCtx context)
        {
            return EventWait(context, true);
        }
