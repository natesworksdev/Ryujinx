...
{
    class ApplicationDisplayService : IpcService
    {
        ...
        public ApplicationDisplayService()
        {
        ...
        {
            MakeObject(context, new SystemDisplayService());
        ...
        {
            MakeObject(context, new ManagerDisplayService());
