            ...
            if (_pid != 0)
            {
                if ((_permissionFlag & 0x40) == 0)
                {
                    ...
                    if (titleId != 0)
                    {
                        ...
                        _ratingAge           = Array.ConvertAll(context.Device.Processes.ActiveProcess.Informations.ApplicationControlProperties.RatingAge.ItemsRo.ToArray(), Convert.ToInt32);
                        _parentalControlFlag = context.Device.Processes.ActiveProcess.Informations.ApplicationControlProperties.ParentalControlFlag;
                    }
                }
