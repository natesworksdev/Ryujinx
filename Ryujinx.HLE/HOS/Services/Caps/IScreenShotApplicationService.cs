...
namespace Ryujinx.HLE.HOS.Services.Caps
{
    ...
    class IScreenShotApplicationService : IpcService
    {
        ...
        public ResultCode SaveScreenShotEx0(ServiceCtx context)
        {
            ...
            ResultCode resultCode = context.Device.System.CaptureManager.SaveScreenShot(screenshotData, appletResourceUserId, context.Device.Processes.ActiveProcess.ProgramId, out ApplicationAlbumEntry applicationAlbumEntry);
