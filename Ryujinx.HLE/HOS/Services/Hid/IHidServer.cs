...
namespace Ryujinx.HLE.HOS.Services.Hid
{
    class HidServer : IpcService
    {
        ...
        private HidNpadStyle                  _npadStyleTag;
        ...
        public HidServer(Horizon system)
        {
            ...
            _npadStyleTag               = HidNpadStyle.FullKey | HidNpadStyle.Dual | HidNpadStyle.Left | HidNpadStyle.Right;
        ...
        public long CreateAppletResource(ServiceCtx context)
        {
            ...
            MakeObject(context, new AppletResource(context.Device.System.HidSharedMem));
        ...
        {
            _npadStyleTag = (HidNpadStyle)context.RequestData.ReadInt32();

            long appletResourceUserId = context.RequestData.ReadInt64();

            Logger.PrintStub(LogClass.ServiceHid, $"Stubbed. AppletResourceUserId: {appletResourceUserId} - " +
                                                  $"NpadStyleTag: {_npadStyleTag}");
        ...
        public long GetSupportedNpadStyleSet(ServiceCtx context)
        {
            ...
            context.ResponseData.Write((int)_npadStyleTag);
        ...
        {
            MakeObject(context, new ActiveApplicationDeviceList());
