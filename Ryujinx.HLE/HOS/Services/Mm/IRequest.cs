...
namespace Ryujinx.HLE.HOS.Services.Mm
{
    ...
    class IRequest : IpcService
    {
        ...
        public ResultCode InitializeOld(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceMm, new { operationType, fgmId, isAutoClearEvent });
        ...
        public ResultCode FinalizeOld(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceMm, new { operationType });
        ...
        public ResultCode SetAndWaitOld(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceMm, new { operationType, value, timeout });
        ...
        public ResultCode Finalize(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceMm, new { id });
        ...
        public ResultCode SetAndWait(ServiceCtx context)
        {
            ...
            Logger.Stub?.Print(LogClass.ServiceMm, new { id, value, timeout });
