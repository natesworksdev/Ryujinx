...
namespace Ryujinx.HLE.HOS.Services.Ns.Aoc
{
    ...
    class IAddOnContentManager : IpcService
    {
        ...
        public ResultCode CountAddOnContent(ServiceCtx context)
        {
            ...
            return CountAddOnContentImpl(context, context.Device.Processes.ActiveProcess.ProgramId);
        }
        ...
        public ResultCode ListAddOnContent(ServiceCtx context)
        {
            ...
            return ListAddContentImpl(context, context.Device.Processes.ActiveProcess.ProgramId);
        }
        ...
        public ResultCode GetAddOnContentBaseId(ServiceCtx context)
        {
            ...
            return GetAddOnContentBaseIdImpl(context, context.Device.Processes.ActiveProcess.ProgramId);
        }
        ...
        public ResultCode PrepareAddOnContent(ServiceCtx context)
        {
            ...
            return PrepareAddOnContentImpl(context, context.Device.Processes.ActiveProcess.ProgramId);
        }
        ...
        public ResultCode GetAddOnContentListChangedEventWithProcessId(ServiceCtx context)
        {
            ...
            ResultCode resultCode = GetAddOnContentBaseIdFromTitleId(context, context.Device.Processes.ActiveProcess.ProgramId);
        ...
        private ResultCode GetAddOnContentBaseIdFromTitleId(ServiceCtx context, ulong titleId)
        {
            ...
            _addOnContentBaseId = context.Device.Processes.ActiveProcess.ApplicationControlProperties.AddOnContentBaseId;
