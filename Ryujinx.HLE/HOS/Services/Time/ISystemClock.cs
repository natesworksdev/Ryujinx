...
namespace Ryujinx.HLE.HOS.Services.Time
{
    internal class ISystemClock : IpcService
    {
        ...
        {
            context.ResponseData.Write((long)(_systemClockContextEpoch - _epoch).TotalSeconds);
        ...
        public long SetSystemClockContext(ServiceCtx context)
        {
            ...
            _systemClockContextEpoch      = _epoch.Add(TimeSpan.FromSeconds(newSystemClockEpoch));
