...
namespace Ryujinx.Ui.Widgets
{
    public partial class GameTableContextMenu : Menu
    {
        ...
        private void OpenTitleModDir_Clicked(object sender, EventArgs args)
        {
            ...
            string titleModsPath = ModLoader.GetTitleDir(modsBasePath, _title.TitleIdString);
        ...
        private void OpenTitleSdModDir_Clicked(object sender, EventArgs args)
        {
            ...
            string titleModsPath = ModLoader.GetTitleDir(sdModsBasePath, _title.TitleIdString);
