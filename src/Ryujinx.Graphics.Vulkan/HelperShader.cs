...
namespace Ryujinx.Graphics.Vulkan
{
    ...
    class HelperShader : IDisposable
    {
            ...
            Rectangle<int> scissor)
        {
            ...
            _pipeline.SetUniformBuffers([new BufferAssignment(1, new BufferRange(bufferHandle, 0, ClearColorBufferSize))]);
            ...
            Rectangle<int> scissor)
        {
            ...
            gd.BufferManager.SetData<float>(bufferHandle, 0, [depthValue]);
        ...
        public unsafe void ChangeStride(VulkanRenderer gd, CommandBufferScoped cbs, BufferHolder src, BufferHolder dst, int srcOffset, int size, int stride, int newStride)
        {
            ...
            if (supportsUint8)
            {
                ...
                _pipeline.SetUniformBuffers([new BufferAssignment(0, new BufferRange(bufferHandle, 0, ParamsBufferSize))]);
            ...
            int indirectDataStride)
        {
            ...
            _pipeline.SetUniformBuffers([new BufferAssignment(0, new BufferRange(patternBufferHandle, 0, ParamsBufferSize))]);
