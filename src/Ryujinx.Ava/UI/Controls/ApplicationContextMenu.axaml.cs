    ...
    public class ApplicationContextMenu : MenuFlyout
    {
        ...
        public void OpenModsDirectory_Click(object sender, RoutedEventArgs args)
        {
            ...
            if (viewModel?.SelectedApplication != null)
            {
                ...
                string titleModsPath = ModLoader.GetTitleDir(modsBasePath, viewModel.SelectedApplication.TitleIdString);
        ...
        public void OpenSdModsDirectory_Click(object sender, RoutedEventArgs args)
        {
            ...
            if (viewModel?.SelectedApplication != null)
            {
                ...
                string titleModsPath = ModLoader.GetTitleDir(sdModsBasePath, viewModel.SelectedApplication.TitleIdString);
