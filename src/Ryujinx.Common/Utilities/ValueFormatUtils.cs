...
namespace Ryujinx.Common.Utilities
{
    public static class ValueFormatUtils
    {
        ...
        {
            "B", "KB", "MB", "GB", "TB", "PB", "EB", // Base 10 units, used for formatting
            "KiB", "MiB", "GiB", "TiB", "PiB", "EiB" // Base 2 units, used for parsing
        };
        ...
        /// Currently only used as a canonical way to format the TimePlayed value.
        /// </summary>
        ...
        /// <summary>
        /// This method parses a string generated by <see cref="FormatTimeSpan"/> back into a <see cref="TimeSpan"/>.
        /// </summary>
