...
namespace ARMeilleure.Translation
{
    static class Delegates
    {
        ...
        static Delegates()
        {
            ...
            SetDelegateInfo(typeof(Math).GetMethod(nameof(Math.Abs),      new[] { typeof(double) }));
            SetDelegateInfo(typeof(Math).GetMethod(nameof(Math.Ceiling),  new[] { typeof(double) }));
            SetDelegateInfo(typeof(Math).GetMethod(nameof(Math.Floor),    new[] { typeof(double) }));
            SetDelegateInfo(typeof(Math).GetMethod(nameof(Math.Round),    new[] { typeof(double), typeof(MidpointRounding) }));
            SetDelegateInfo(typeof(Math).GetMethod(nameof(Math.Truncate), new[] { typeof(double) }));

            SetDelegateInfo(typeof(MathF).GetMethod(nameof(MathF.Abs),      new[] { typeof(float) }));
            SetDelegateInfo(typeof(MathF).GetMethod(nameof(MathF.Ceiling),  new[] { typeof(float) }));
            SetDelegateInfo(typeof(MathF).GetMethod(nameof(MathF.Floor),    new[] { typeof(float) }));
            SetDelegateInfo(typeof(MathF).GetMethod(nameof(MathF.Round),    new[] { typeof(float), typeof(MidpointRounding) }));
            SetDelegateInfo(typeof(MathF).GetMethod(nameof(MathF.Truncate), new[] { typeof(float) }));
