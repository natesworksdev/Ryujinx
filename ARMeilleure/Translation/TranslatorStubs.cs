...
namespace ARMeilleure.Translation
{
    ...
    class TranslatorStubs : IDisposable
    {
        ...
        private IntPtr GenerateDispatchStub()
        {
            ...
            var func = Compiler.Compile<GuestFunction>(cfg, argTypes, retType, CompilerOptions.HighCq, _translator.JitCache);
        ...
        private DispatcherFunction GenerateDispatchLoop()
        {
            ...
            return Compiler.Compile<DispatcherFunction>(cfg, argTypes, retType, CompilerOptions.HighCq, _translator.JitCache);
        }
    }
}
