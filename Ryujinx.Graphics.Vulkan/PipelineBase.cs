...
namespace Ryujinx.Graphics.Vulkan
{
    class PipelineBase : IDisposable
    {
        ...
        public unsafe void ClearRenderTargetColor(int index, int layer, uint componentMask, ColorF color)
        {
            ...
            var clearRect = FramebufferParams?.GetClearRect(layer) ?? default;
