...
namespace Ryujinx.Graphics.Texture
{
    ...
    {
        private struct TexelWeightParams
        {
            public int  Width;
            public int  Height;
        ...
        private static void UnquantizeTexelWeights(
            int[][]              outputBuffer, 
            ...
            switch (intEncoded.GetEncoding())
            {
                ...
                case IntegerEncoded.EIntegerEncoding.Trit:
                {
                    ...
                    switch (bitLength)
                    {
                        ...
                        {
                            c = 23;
                            int bVal = (bitValue >> 1) & 1;
                            b = (bVal << 6) | (bVal << 2) | bVal;
        ...
        private static void DecodeColorValues(
            int[]  outputValues, 
            byte[] inputData, 
            uint[] modes, 
