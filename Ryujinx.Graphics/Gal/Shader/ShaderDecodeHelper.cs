...
{
    internal static class ShaderDecodeHelper
    {
        private static readonly ShaderIrOperImmf _immfZero = new ShaderIrOperImmf(0);
        private static readonly ShaderIrOperImmf _immfOne  = new ShaderIrOperImmf(1);
        ...
        {
            return sat ? new ShaderIrOp(ShaderIrInst.Fclamp, node, _immfZero, _immfOne) : node;
        }
