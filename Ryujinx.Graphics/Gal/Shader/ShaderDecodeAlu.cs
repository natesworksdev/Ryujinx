    ...
    internal static partial class ShaderDecode
    {
        ...
        private static void EmitMnmx(ShaderIrBlock block, long opCode, bool isFloat, ShaderOper oper)
        {
            ...
            else
            {
                ...
                block.AddNode(opCode.PredNode(new ShaderIrCond(predN, asgMax, true)));
                block.AddNode(opCode.PredNode(new ShaderIrCond(predN, asgMin, false)));
            }
        }
        ...
        private static void EmitSet(ShaderIrBlock block, long opCode, bool isFloat, ShaderOper oper)
        {
            ...
            if (lopInst != ShaderIrInst.Band || !pNode.IsConst)
            {
                ...
                asg0 = new ShaderIrCond(op2, asg0, true);
                asg1 = new ShaderIrCond(op2, asg1, false);
            }
            else
            {
                asg0 = new ShaderIrCond(op, asg0, true);
                asg1 = new ShaderIrCond(op, asg1, false);
            }
