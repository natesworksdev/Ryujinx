...
{
    internal class OGLRasterizer : IGalRasterizer
    {
        ...
        public OGLRasterizer()
        {
            ...
            _vboCache = new OGLCachedResource<int>(GL.DeleteBuffer);
            _iboCache = new OGLCachedResource<int>(GL.DeleteBuffer);
        ...
        public void CreateVbo(long key, int dataSize, IntPtr hostAddress)
        {
            ...
            _vboCache.AddOrUpdate(key, handle, (uint)dataSize);
