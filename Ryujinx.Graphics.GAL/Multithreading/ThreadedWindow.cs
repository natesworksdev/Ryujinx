...
namespace Ryujinx.Graphics.GAL.Multithreading
{
    public class ThreadedWindow : IWindow
    {
        ...
        public void Present(ITexture texture, ImageCrop crop, Action<int> swapBuffersCallback)
        {
            ...
            _renderer.New<WindowPresentCommand>().Set(new TableRef<ThreadedTexture>(_renderer, texture as ThreadedTexture), crop, new TableRef<Action<int>>(_renderer, swapBuffersCallback));
