...
namespace Ryujinx.Audio.Renderer.Dsp.State
{
    ...
    {
        private readonly float[] FdnDelayMinTimes = { 5.0f, 6.0f, 13.0f, 14.0f };
        private readonly float[] FdnDelayMaxTimes = { 45.704f, 82.782f, 149.94f, 271.58f };
        private readonly float[] DecayDelayMaxTimes1 = { 17.0f, 13.0f, 9.0f, 7.0f };
        private readonly float[] DecayDelayMaxTimes2 = { 19.0f, 11.0f, 10.0f, 6.0f };
        private readonly float[] EarlyDelayTimes = { 0.017136f, 0.059154f, 0.16173f, 0.39019f, 0.42526f, 0.45541f, 0.68974f, 0.74591f, 0.83384f, 0.8595f, 0.0f, 0.075024f, 0.16879f, 0.2999f, 0.33744f, 0.3719f, 0.59901f, 0.71674f, 0.81786f, 0.85166f };
