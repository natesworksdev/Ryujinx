...
namespace Ryujinx.Audio.Renderer.Server.Voice
{
    ...
    public struct VoiceState
    {
        ...
        public void WriteOutStatus(ref VoiceOutStatus outStatus, ref VoiceInParameter parameter, Span<Memory<VoiceUpdateState>> voiceUpdateStates)
        {
#if DEBUG
        ...
        /// <param name="behaviourContext">The behaviour context.</param>
        public void UpdateWaveBuffers(out ErrorInfo[] errorInfos, ref VoiceInParameter parameter, Span<Memory<VoiceUpdateState>> voiceUpdateStates, ref PoolMapper mapper, ref BehaviourContext behaviourContext)
        {
