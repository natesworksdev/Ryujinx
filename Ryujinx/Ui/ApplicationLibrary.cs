...
namespace Ryujinx.Ui
{
    public class ApplicationLibrary
    {
        ...
        {
            string metadataFolder = Path.Combine(AppDataManager.GetGamesPath(), titleId, "gui");
        ...
        {
            string jsonPath = Path.Combine(AppDataManager.GetGamesPath(), titleId, "updates.json");
