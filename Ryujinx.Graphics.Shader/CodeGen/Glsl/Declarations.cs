    ...
    static class Declarations
    {
        ...
        public static string GetVarTypeName(AggregateType type)
        {
            return type switch
            {
                ...
                AggregateType.FP32 => "precise float",
                AggregateType.FP64 => "double",
                AggregateType.S32 => "int",
                AggregateType.U32 => "uint",
                AggregateType.Vector2 | AggregateType.Bool => "bvec2",
                AggregateType.Vector2 | AggregateType.FP32 => "precise vec2",
                ...
                AggregateType.Vector3 | AggregateType.FP32 => "precise vec3",
                ...
                AggregateType.Vector4 | AggregateType.FP32 => "precise vec4",
