...
namespace Ryujinx.Graphics.Shader.Instructions
{
    static partial class InstEmit
    {
        public static void Vmad(EmitterContext context)
        {
            ...
            bool resultSigned = isSigned(op.RaType) || isSigned(op.RbType);

            Operand result;

            int shr = op.RawOpCode.Extract(51, 2);

            result = context.IMultiply(GetSrcA(context), GetSrcB(context));
            result = context.IAdd(result, GetSrcC(context));
        ...
        public static bool isSigned(VideoType t)
        {
            return t == VideoType.S16 || t == VideoType.S8 || t == VideoType.S32;
        }
