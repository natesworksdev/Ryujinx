...
namespace SoundIOSharp
{
    ...
    {
        [CTypeDetails("Pointer<void>")] public IntPtr userdata;
        ...
        [CTypeDetails("Pointer<byte>")] public IntPtr app_name;
    ...
    class Natives
    {
        ...
        [DllImport(LibraryName)]
        internal static extern bool soundio_channel_layout_equal([CTypeDetails("Pointer<SoundIoChannelLayout>")]IntPtr a, [CTypeDetails("Pointer<SoundIoChannelLayout>")]IntPtr b);
        ...
        [DllImport(LibraryName)]
        internal static extern SoundIoChannelId soundio_parse_channel_id([CTypeDetails("Pointer<byte>")]IntPtr str, int str_len);
        ...
        [DllImport(LibraryName)]
        internal static extern bool soundio_channel_layout_detect_builtin([CTypeDetails("Pointer<SoundIoChannelLayout>")]IntPtr layout);
        ...
        [DllImport(LibraryName)]
        internal static extern bool soundio_device_equal([CTypeDetails("Pointer<SoundIoDevice>")]IntPtr a, [CTypeDetails("Pointer<SoundIoDevice>")]IntPtr b);
        ...
        [DllImport(LibraryName)]
        internal static extern bool soundio_device_supports_format([CTypeDetails("Pointer<SoundIoDevice>")]IntPtr device, SoundIoFormat format);

        // function soundio_device_supports_layout - soundio.h (909, 21)
        [DllImport(LibraryName)]
        internal static extern bool soundio_device_supports_layout([CTypeDetails("Pointer<SoundIoDevice>")]IntPtr device, [CTypeDetails("Pointer<SoundIoChannelLayout>")]IntPtr layout);

        // function soundio_device_supports_sample_rate - soundio.h (914, 21)
        [DllImport(LibraryName)]
        internal static extern bool soundio_device_supports_sample_rate([CTypeDetails("Pointer<SoundIoDevice>")]IntPtr device, int sample_rate);
        ...
        [DllImport(LibraryName)]
        internal static extern int soundio_outstream_begin_write([CTypeDetails("Pointer<SoundIoOutStream>")]IntPtr outstream, [CTypeDetails("Pointer<System.IntPtr>")]IntPtr areas, [CTypeDetails("Pointer<int>")]IntPtr frame_count);
        ...
        [DllImport(LibraryName)]
        internal static extern int soundio_outstream_pause([CTypeDetails("Pointer<SoundIoOutStream>")]IntPtr outstream, bool pause);
        ...
        [DllImport(LibraryName)]
        internal static extern int soundio_instream_begin_read([CTypeDetails("Pointer<SoundIoInStream>")]IntPtr instream, [CTypeDetails("Pointer<System.IntPtr>")]IntPtr areas, [CTypeDetails("Pointer<int>")]IntPtr frame_count);
        ...
        [DllImport(LibraryName)]
        internal static extern int soundio_instream_pause([CTypeDetails("Pointer<SoundIoInStream>")]IntPtr instream, bool pause);
