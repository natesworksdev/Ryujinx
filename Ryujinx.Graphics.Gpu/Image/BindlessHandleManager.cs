...
namespace Ryujinx.Graphics.Gpu.Image
{
    ...
    class BindlessHandleManager
    {
        ...
        public BindlessHandleManager(IRenderer renderer)
        {
        ...
        private static ITexture CreateBufferTexture<T>(IRenderer renderer, TypedBuffer<T> buffer) where T : unmanaged
        {
        ...
        {
            renderer.Pipeline.SetTexture(0, _bufferTextureForTextureList);
            renderer.Pipeline.SetTexture(1, _bufferTextureForHandleList);
        }
