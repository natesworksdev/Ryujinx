...
namespace Ryujinx.Graphics.Gpu.Image
{
    ...
    static class FormatTable
    {
        private static Dictionary<uint, FormatInfo> _textureFormats = new Dictionary<uint, FormatInfo>()
        {
            ...
            { 0x2493a, new FormatInfo(Format.D16Unorm,          1,  1,  2,  4) },
            { 0x7ffaf, new FormatInfo(Format.D32Float,          1,  1,  4,  1) },
            { 0x24a0e, new FormatInfo(Format.D24UnormS8Uint,    1,  1,  4,  4) },
            { 0x24a29, new FormatInfo(Format.D24UnormS8Uint,    1,  1,  4,  4) },
            { 0x25385, new FormatInfo(Format.D32FloatS8Uint,    1,  1,  8,  4) },
            { 0x253b0, new FormatInfo(Format.D32FloatS8Uint,    1,  1,  8,  4) },
