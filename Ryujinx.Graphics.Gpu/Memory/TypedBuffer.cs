...
namespace Ryujinx.Graphics.Gpu.Memory
{
    ...
    class TypedBuffer<T> where T : unmanaged
    {
        ...
        /// <summary>
        /// Reads data from a given index on the buffer.
        /// </summary>
        /// <param name="index">Element index</param>
        /// <returns>Data</returns>
        public T Read(int index)
        {
            return MemoryMarshal.Cast<byte, T>(new Span<byte>(_renderer.GetBufferData(_buffer, index * Unsafe.SizeOf<T>(), Unsafe.SizeOf<T>())))[0];
        }
