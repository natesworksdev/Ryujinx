...
namespace Ryujinx.Graphics.Gpu.Engine.Threed.Blender
{
    static class AdvancedBlendFunctions
    {
        ...
        {
            new AdvancedBlendUcode(AdvancedBlendMode.PlusClamped,      AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedPlusClampedPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.PlusClampedAlpha, AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedPlusClampedAlphaPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.PlusDarker,       AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedPlusDarkerPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Multiply,         AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedMultiplyPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Screen,           AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedScreenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Overlay,          AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedOverlayPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Darken,           AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedDarkenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Lighten,          AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedLightenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorDodge,       AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedColorDodgePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorBurn,        AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedColorBurnPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HardLight,        AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedHardLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SoftLight,        AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedSoftLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Difference,       AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedDifferencePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Minus,            AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedMinusPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.MinusClamped,     AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedMinusClampedPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Exclusion,        AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedExclusionPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Contrast,         AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedContrastPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Invert,           AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedInvertPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.InvertRGB,        AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedInvertRGBPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.InvertOvg,        AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedInvertOvgPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearDodge,      AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedLinearDodgePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearBurn,       AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedLinearBurnPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.VividLight,       AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedVividLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearLight,      AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedLinearLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.PinLight,         AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedPinLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HardMix,          AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedHardMixPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Red,              AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedRedPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Green,            AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedGreenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Blue,             AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedBluePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslHue,           AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedHslHuePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslSaturation,    AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedHslSaturationPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslColor,         AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedHslColorPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslLuminosity,    AdvancedBlendOverlap.Uncorrelated, true,  GenUncorrelatedHslLuminosityPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Src,              AdvancedBlendOverlap.Disjoint,     true,  GenDisjointSrcPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Dst,              AdvancedBlendOverlap.Disjoint,     true,  GenDisjointDstPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOver,          AdvancedBlendOverlap.Disjoint,     true,  GenDisjointSrcOverPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstOver,          AdvancedBlendOverlap.Disjoint,     true,  GenDisjointDstOverPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcIn,            AdvancedBlendOverlap.Disjoint,     true,  GenDisjointSrcInPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstIn,            AdvancedBlendOverlap.Disjoint,     true,  GenDisjointDstInPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOut,           AdvancedBlendOverlap.Disjoint,     true,  GenDisjointSrcOutPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstOut,           AdvancedBlendOverlap.Disjoint,     true,  GenDisjointDstOutPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcAtop,          AdvancedBlendOverlap.Disjoint,     true,  GenDisjointSrcAtopPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstAtop,          AdvancedBlendOverlap.Disjoint,     true,  GenDisjointDstAtopPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Xor,              AdvancedBlendOverlap.Disjoint,     true,  GenDisjointXorPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Plus,             AdvancedBlendOverlap.Disjoint,     true,  GenDisjointPlusPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Multiply,         AdvancedBlendOverlap.Disjoint,     true,  GenDisjointMultiplyPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Screen,           AdvancedBlendOverlap.Disjoint,     true,  GenDisjointScreenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Overlay,          AdvancedBlendOverlap.Disjoint,     true,  GenDisjointOverlayPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Darken,           AdvancedBlendOverlap.Disjoint,     true,  GenDisjointDarkenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Lighten,          AdvancedBlendOverlap.Disjoint,     true,  GenDisjointLightenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorDodge,       AdvancedBlendOverlap.Disjoint,     true,  GenDisjointColorDodgePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorBurn,        AdvancedBlendOverlap.Disjoint,     true,  GenDisjointColorBurnPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HardLight,        AdvancedBlendOverlap.Disjoint,     true,  GenDisjointHardLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SoftLight,        AdvancedBlendOverlap.Disjoint,     true,  GenDisjointSoftLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Difference,       AdvancedBlendOverlap.Disjoint,     true,  GenDisjointDifferencePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Exclusion,        AdvancedBlendOverlap.Disjoint,     true,  GenDisjointExclusionPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Invert,           AdvancedBlendOverlap.Disjoint,     true,  GenDisjointInvertPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.InvertRGB,        AdvancedBlendOverlap.Disjoint,     true,  GenDisjointInvertRGBPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearDodge,      AdvancedBlendOverlap.Disjoint,     true,  GenDisjointLinearDodgePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearBurn,       AdvancedBlendOverlap.Disjoint,     true,  GenDisjointLinearBurnPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.VividLight,       AdvancedBlendOverlap.Disjoint,     true,  GenDisjointVividLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearLight,      AdvancedBlendOverlap.Disjoint,     true,  GenDisjointLinearLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.PinLight,         AdvancedBlendOverlap.Disjoint,     true,  GenDisjointPinLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HardMix,          AdvancedBlendOverlap.Disjoint,     true,  GenDisjointHardMixPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslHue,           AdvancedBlendOverlap.Disjoint,     true,  GenDisjointHslHuePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslSaturation,    AdvancedBlendOverlap.Disjoint,     true,  GenDisjointHslSaturationPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslColor,         AdvancedBlendOverlap.Disjoint,     true,  GenDisjointHslColorPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslLuminosity,    AdvancedBlendOverlap.Disjoint,     true,  GenDisjointHslLuminosityPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Src,              AdvancedBlendOverlap.Conjoint,     true,  GenConjointSrcPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Dst,              AdvancedBlendOverlap.Conjoint,     true,  GenConjointDstPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOver,          AdvancedBlendOverlap.Conjoint,     true,  GenConjointSrcOverPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstOver,          AdvancedBlendOverlap.Conjoint,     true,  GenConjointDstOverPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcIn,            AdvancedBlendOverlap.Conjoint,     true,  GenConjointSrcInPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstIn,            AdvancedBlendOverlap.Conjoint,     true,  GenConjointDstInPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOut,           AdvancedBlendOverlap.Conjoint,     true,  GenConjointSrcOutPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstOut,           AdvancedBlendOverlap.Conjoint,     true,  GenConjointDstOutPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcAtop,          AdvancedBlendOverlap.Conjoint,     true,  GenConjointSrcAtopPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstAtop,          AdvancedBlendOverlap.Conjoint,     true,  GenConjointDstAtopPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Xor,              AdvancedBlendOverlap.Conjoint,     true,  GenConjointXorPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Multiply,         AdvancedBlendOverlap.Conjoint,     true,  GenConjointMultiplyPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Screen,           AdvancedBlendOverlap.Conjoint,     true,  GenConjointScreenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Overlay,          AdvancedBlendOverlap.Conjoint,     true,  GenConjointOverlayPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Darken,           AdvancedBlendOverlap.Conjoint,     true,  GenConjointDarkenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Lighten,          AdvancedBlendOverlap.Conjoint,     true,  GenConjointLightenPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorDodge,       AdvancedBlendOverlap.Conjoint,     true,  GenConjointColorDodgePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorBurn,        AdvancedBlendOverlap.Conjoint,     true,  GenConjointColorBurnPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HardLight,        AdvancedBlendOverlap.Conjoint,     true,  GenConjointHardLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.SoftLight,        AdvancedBlendOverlap.Conjoint,     true,  GenConjointSoftLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Difference,       AdvancedBlendOverlap.Conjoint,     true,  GenConjointDifferencePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Exclusion,        AdvancedBlendOverlap.Conjoint,     true,  GenConjointExclusionPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.Invert,           AdvancedBlendOverlap.Conjoint,     true,  GenConjointInvertPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.InvertRGB,        AdvancedBlendOverlap.Conjoint,     true,  GenConjointInvertRGBPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearDodge,      AdvancedBlendOverlap.Conjoint,     true,  GenConjointLinearDodgePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearBurn,       AdvancedBlendOverlap.Conjoint,     true,  GenConjointLinearBurnPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.VividLight,       AdvancedBlendOverlap.Conjoint,     true,  GenConjointVividLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearLight,      AdvancedBlendOverlap.Conjoint,     true,  GenConjointLinearLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.PinLight,         AdvancedBlendOverlap.Conjoint,     true,  GenConjointPinLightPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HardMix,          AdvancedBlendOverlap.Conjoint,     true,  GenConjointHardMixPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslHue,           AdvancedBlendOverlap.Conjoint,     true,  GenConjointHslHuePremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslSaturation,    AdvancedBlendOverlap.Conjoint,     true,  GenConjointHslSaturationPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslColor,         AdvancedBlendOverlap.Conjoint,     true,  GenConjointHslColorPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.HslLuminosity,    AdvancedBlendOverlap.Conjoint,     true,  GenConjointHslLuminosityPremul),
            new AdvancedBlendUcode(AdvancedBlendMode.DstOver,          AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedDstOver),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcIn,            AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedSrcIn),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOut,           AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedSrcOut),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcAtop,          AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedSrcAtop),
            new AdvancedBlendUcode(AdvancedBlendMode.DstAtop,          AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedDstAtop),
            new AdvancedBlendUcode(AdvancedBlendMode.Xor,              AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedXor),
            new AdvancedBlendUcode(AdvancedBlendMode.PlusClamped,      AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedPlusClamped),
            new AdvancedBlendUcode(AdvancedBlendMode.PlusClampedAlpha, AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedPlusClampedAlpha),
            new AdvancedBlendUcode(AdvancedBlendMode.PlusDarker,       AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedPlusDarker),
            new AdvancedBlendUcode(AdvancedBlendMode.Multiply,         AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedMultiply),
            new AdvancedBlendUcode(AdvancedBlendMode.Screen,           AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedScreen),
            new AdvancedBlendUcode(AdvancedBlendMode.Overlay,          AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedOverlay),
            new AdvancedBlendUcode(AdvancedBlendMode.Darken,           AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedDarken),
            new AdvancedBlendUcode(AdvancedBlendMode.Lighten,          AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedLighten),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorDodge,       AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedColorDodge),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorBurn,        AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedColorBurn),
            new AdvancedBlendUcode(AdvancedBlendMode.HardLight,        AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedHardLight),
            new AdvancedBlendUcode(AdvancedBlendMode.SoftLight,        AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedSoftLight),
            new AdvancedBlendUcode(AdvancedBlendMode.Difference,       AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedDifference),
            new AdvancedBlendUcode(AdvancedBlendMode.Minus,            AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedMinus),
            new AdvancedBlendUcode(AdvancedBlendMode.MinusClamped,     AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedMinusClamped),
            new AdvancedBlendUcode(AdvancedBlendMode.Exclusion,        AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedExclusion),
            new AdvancedBlendUcode(AdvancedBlendMode.Contrast,         AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedContrast),
            new AdvancedBlendUcode(AdvancedBlendMode.InvertRGB,        AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedInvertRGB),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearDodge,      AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedLinearDodge),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearBurn,       AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedLinearBurn),
            new AdvancedBlendUcode(AdvancedBlendMode.VividLight,       AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedVividLight),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearLight,      AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedLinearLight),
            new AdvancedBlendUcode(AdvancedBlendMode.PinLight,         AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedPinLight),
            new AdvancedBlendUcode(AdvancedBlendMode.HardMix,          AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedHardMix),
            new AdvancedBlendUcode(AdvancedBlendMode.Red,              AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedRed),
            new AdvancedBlendUcode(AdvancedBlendMode.Green,            AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedGreen),
            new AdvancedBlendUcode(AdvancedBlendMode.Blue,             AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedBlue),
            new AdvancedBlendUcode(AdvancedBlendMode.HslHue,           AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedHslHue),
            new AdvancedBlendUcode(AdvancedBlendMode.HslSaturation,    AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedHslSaturation),
            new AdvancedBlendUcode(AdvancedBlendMode.HslColor,         AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedHslColor),
            new AdvancedBlendUcode(AdvancedBlendMode.HslLuminosity,    AdvancedBlendOverlap.Uncorrelated, false, GenUncorrelatedHslLuminosity),
            new AdvancedBlendUcode(AdvancedBlendMode.Src,              AdvancedBlendOverlap.Disjoint,     false, GenDisjointSrc),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOver,          AdvancedBlendOverlap.Disjoint,     false, GenDisjointSrcOver),
            new AdvancedBlendUcode(AdvancedBlendMode.DstOver,          AdvancedBlendOverlap.Disjoint,     false, GenDisjointDstOver),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcIn,            AdvancedBlendOverlap.Disjoint,     false, GenDisjointSrcIn),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOut,           AdvancedBlendOverlap.Disjoint,     false, GenDisjointSrcOut),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcAtop,          AdvancedBlendOverlap.Disjoint,     false, GenDisjointSrcAtop),
            new AdvancedBlendUcode(AdvancedBlendMode.DstAtop,          AdvancedBlendOverlap.Disjoint,     false, GenDisjointDstAtop),
            new AdvancedBlendUcode(AdvancedBlendMode.Xor,              AdvancedBlendOverlap.Disjoint,     false, GenDisjointXor),
            new AdvancedBlendUcode(AdvancedBlendMode.Plus,             AdvancedBlendOverlap.Disjoint,     false, GenDisjointPlus),
            new AdvancedBlendUcode(AdvancedBlendMode.Multiply,         AdvancedBlendOverlap.Disjoint,     false, GenDisjointMultiply),
            new AdvancedBlendUcode(AdvancedBlendMode.Screen,           AdvancedBlendOverlap.Disjoint,     false, GenDisjointScreen),
            new AdvancedBlendUcode(AdvancedBlendMode.Overlay,          AdvancedBlendOverlap.Disjoint,     false, GenDisjointOverlay),
            new AdvancedBlendUcode(AdvancedBlendMode.Darken,           AdvancedBlendOverlap.Disjoint,     false, GenDisjointDarken),
            new AdvancedBlendUcode(AdvancedBlendMode.Lighten,          AdvancedBlendOverlap.Disjoint,     false, GenDisjointLighten),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorDodge,       AdvancedBlendOverlap.Disjoint,     false, GenDisjointColorDodge),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorBurn,        AdvancedBlendOverlap.Disjoint,     false, GenDisjointColorBurn),
            new AdvancedBlendUcode(AdvancedBlendMode.HardLight,        AdvancedBlendOverlap.Disjoint,     false, GenDisjointHardLight),
            new AdvancedBlendUcode(AdvancedBlendMode.SoftLight,        AdvancedBlendOverlap.Disjoint,     false, GenDisjointSoftLight),
            new AdvancedBlendUcode(AdvancedBlendMode.Difference,       AdvancedBlendOverlap.Disjoint,     false, GenDisjointDifference),
            new AdvancedBlendUcode(AdvancedBlendMode.Exclusion,        AdvancedBlendOverlap.Disjoint,     false, GenDisjointExclusion),
            new AdvancedBlendUcode(AdvancedBlendMode.InvertRGB,        AdvancedBlendOverlap.Disjoint,     false, GenDisjointInvertRGB),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearDodge,      AdvancedBlendOverlap.Disjoint,     false, GenDisjointLinearDodge),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearBurn,       AdvancedBlendOverlap.Disjoint,     false, GenDisjointLinearBurn),
            new AdvancedBlendUcode(AdvancedBlendMode.VividLight,       AdvancedBlendOverlap.Disjoint,     false, GenDisjointVividLight),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearLight,      AdvancedBlendOverlap.Disjoint,     false, GenDisjointLinearLight),
            new AdvancedBlendUcode(AdvancedBlendMode.PinLight,         AdvancedBlendOverlap.Disjoint,     false, GenDisjointPinLight),
            new AdvancedBlendUcode(AdvancedBlendMode.HardMix,          AdvancedBlendOverlap.Disjoint,     false, GenDisjointHardMix),
            new AdvancedBlendUcode(AdvancedBlendMode.HslHue,           AdvancedBlendOverlap.Disjoint,     false, GenDisjointHslHue),
            new AdvancedBlendUcode(AdvancedBlendMode.HslSaturation,    AdvancedBlendOverlap.Disjoint,     false, GenDisjointHslSaturation),
            new AdvancedBlendUcode(AdvancedBlendMode.HslColor,         AdvancedBlendOverlap.Disjoint,     false, GenDisjointHslColor),
            new AdvancedBlendUcode(AdvancedBlendMode.HslLuminosity,    AdvancedBlendOverlap.Disjoint,     false, GenDisjointHslLuminosity),
            new AdvancedBlendUcode(AdvancedBlendMode.Src,              AdvancedBlendOverlap.Conjoint,     false, GenConjointSrc),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOver,          AdvancedBlendOverlap.Conjoint,     false, GenConjointSrcOver),
            new AdvancedBlendUcode(AdvancedBlendMode.DstOver,          AdvancedBlendOverlap.Conjoint,     false, GenConjointDstOver),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcIn,            AdvancedBlendOverlap.Conjoint,     false, GenConjointSrcIn),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcOut,           AdvancedBlendOverlap.Conjoint,     false, GenConjointSrcOut),
            new AdvancedBlendUcode(AdvancedBlendMode.SrcAtop,          AdvancedBlendOverlap.Conjoint,     false, GenConjointSrcAtop),
            new AdvancedBlendUcode(AdvancedBlendMode.DstAtop,          AdvancedBlendOverlap.Conjoint,     false, GenConjointDstAtop),
            new AdvancedBlendUcode(AdvancedBlendMode.Xor,              AdvancedBlendOverlap.Conjoint,     false, GenConjointXor),
            new AdvancedBlendUcode(AdvancedBlendMode.Multiply,         AdvancedBlendOverlap.Conjoint,     false, GenConjointMultiply),
            new AdvancedBlendUcode(AdvancedBlendMode.Screen,           AdvancedBlendOverlap.Conjoint,     false, GenConjointScreen),
            new AdvancedBlendUcode(AdvancedBlendMode.Overlay,          AdvancedBlendOverlap.Conjoint,     false, GenConjointOverlay),
            new AdvancedBlendUcode(AdvancedBlendMode.Darken,           AdvancedBlendOverlap.Conjoint,     false, GenConjointDarken),
            new AdvancedBlendUcode(AdvancedBlendMode.Lighten,          AdvancedBlendOverlap.Conjoint,     false, GenConjointLighten),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorDodge,       AdvancedBlendOverlap.Conjoint,     false, GenConjointColorDodge),
            new AdvancedBlendUcode(AdvancedBlendMode.ColorBurn,        AdvancedBlendOverlap.Conjoint,     false, GenConjointColorBurn),
            new AdvancedBlendUcode(AdvancedBlendMode.HardLight,        AdvancedBlendOverlap.Conjoint,     false, GenConjointHardLight),
            new AdvancedBlendUcode(AdvancedBlendMode.SoftLight,        AdvancedBlendOverlap.Conjoint,     false, GenConjointSoftLight),
            new AdvancedBlendUcode(AdvancedBlendMode.Difference,       AdvancedBlendOverlap.Conjoint,     false, GenConjointDifference),
            new AdvancedBlendUcode(AdvancedBlendMode.Exclusion,        AdvancedBlendOverlap.Conjoint,     false, GenConjointExclusion),
            new AdvancedBlendUcode(AdvancedBlendMode.InvertRGB,        AdvancedBlendOverlap.Conjoint,     false, GenConjointInvertRGB),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearDodge,      AdvancedBlendOverlap.Conjoint,     false, GenConjointLinearDodge),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearBurn,       AdvancedBlendOverlap.Conjoint,     false, GenConjointLinearBurn),
            new AdvancedBlendUcode(AdvancedBlendMode.VividLight,       AdvancedBlendOverlap.Conjoint,     false, GenConjointVividLight),
            new AdvancedBlendUcode(AdvancedBlendMode.LinearLight,      AdvancedBlendOverlap.Conjoint,     false, GenConjointLinearLight),
            new AdvancedBlendUcode(AdvancedBlendMode.PinLight,         AdvancedBlendOverlap.Conjoint,     false, GenConjointPinLight),
            new AdvancedBlendUcode(AdvancedBlendMode.HardMix,          AdvancedBlendOverlap.Conjoint,     false, GenConjointHardMix),
            new AdvancedBlendUcode(AdvancedBlendMode.HslHue,           AdvancedBlendOverlap.Conjoint,     false, GenConjointHslHue),
            new AdvancedBlendUcode(AdvancedBlendMode.HslSaturation,    AdvancedBlendOverlap.Conjoint,     false, GenConjointHslSaturation),
