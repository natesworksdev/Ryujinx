...
namespace Ryujinx.Graphics.OpenGL.Image
{
    ...
    class BindlessHandleManager
    {
        ...
        public BindlessHandleManager(Renderer renderer)
        {
        ...
        private static ITexture CreateBufferTexture<T>(Renderer renderer, TypedBuffer<T> buffer) where T : unmanaged
        {
        ...
        {
            renderer.Pipeline.SetTextureAndSampler(0, _bufferTextureForTextureList, null);
            renderer.Pipeline.SetTextureAndSampler(1, _bufferTextureForHandleList, null);
        }
