...
namespace Ryujinx.Tests.Cpu
{
    ...
    public sealed class CpuTestAluRs : CpuTest
    {
                              ...
                              [Values] bool carryIn)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: xn, x2: xm, x31: x31, carry: carryIn);
                              ...
                              [Values] bool carryIn)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: wn, x2: wm, x31: w31, carry: carryIn);
                              ...
                              [Values(0u, 31u, 32u, 63u)] [Random(0u, 63u, RndCntAmount)] uint amount)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: xn, x2: xm, x31: x31);
                              ...
                              [Values(0u, 15u, 16u, 31u)] [Random(0u, 31u, RndCntAmount)] uint amount)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: wn, x2: wm, x31: w31);
                                   ...
                                   (ulong)0xFF_FF_FF_FF_FF_FF_FF_FF)] [Random(RndCnt)] ulong xm)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: wn, x2: xm, x31: w31);
