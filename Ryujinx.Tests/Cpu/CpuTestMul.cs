...
namespace Ryujinx.Tests.Cpu
{
    ...
    public sealed class CpuTestMul : CpuTest
    {
                                       ...
                                       0x8000000000000000ul, 0xFFFFFFFFFFFFFFFFul)] [Random(RndCnt)] ulong xa)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: xn, x2: xm, x3: xa, x31: x31);
                                       ...
                                       0x80000000u, 0xFFFFFFFFu)] [Random(RndCnt)] uint wa)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: wn, x2: wm, x3: wa, x31: w31);
                                         ...
                                         0x8000000000000000ul, 0xFFFFFFFFFFFFFFFFul)] [Random(RndCnt)] ulong xa)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: wn, x2: wm, x3: xa, x31: x31);
