    ...
    public sealed class CpuTestAluRx : CpuTest
    {
                                ...
                                [Values(0u, 1u, 2u, 3u, 4u)] uint amount)
        {
            ...
            if (rn != 31)
            {
                ...
                threadState = SingleOpcode(opcode, x1: xnSp, x2: xm, x31: x31);
            }
            else
            {
                threadState = SingleOpcode(opcode, x31: xnSp, x2: xm);
            }
                                ...
                                [Values(0u, 1u, 2u, 3u, 4u)] uint amount)
        {
            ...
            if (rn != 31)
            {
                ...
                threadState = SingleOpcode(opcode, x1: xnSp, x2: wm, x31: x31);
            }
            else
            {
                threadState = SingleOpcode(opcode, x31: xnSp, x2: wm);
            }
                                ...
                                [Values(0u, 1u, 2u, 3u, 4u)] uint amount)
        {
            ...
            if (rn != 31)
            {
                ...
                threadState = SingleOpcode(opcode, x1: wnWsp, x2: wm, x31: w31);
            }
            else
            {
                threadState = SingleOpcode(opcode, x31: wnWsp, x2: wm);
            }
                                 ...
                                 [Values(0u, 1u, 2u, 3u, 4u)] uint amount)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: xnSp, x2: xm, x31: xnSp);
                                 ...
                                 [Values(0u, 1u, 2u, 3u, 4u)] uint amount)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: xnSp, x2: wm, x31: xnSp);
                                 ...
                                 [Values(0u, 1u, 2u, 3u, 4u)] uint amount)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: wnWsp, x2: wm, x31: wnWsp);
