...
namespace Ryujinx.Tests.Cpu
{
    ...
    public sealed class CpuTestBfm : CpuTest
    {
                              ...
                              [Values(0u, 31u, 32u, 63u)] [Random(0u, 63u, RndCntImms)] uint imms)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, xd, xn, x31: x31);
                              ...
                              [Values(0u, 15u, 16u, 31u)] [Random(0u, 31u, RndCntImms)] uint imms)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, wd, wn, x31: w31);
                               ...
                               [Values(0u, 31u, 32u, 63u)] [Random(0u, 63u, RndCntImms)] uint imms)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: xn, x31: x31);
                               ...
                               [Values(0u, 15u, 16u, 31u)] [Random(0u, 31u, RndCntImms)] uint imms)
        {
            ...
            AThreadState threadState = SingleOpcode(opcode, x1: wn, x31: w31);
