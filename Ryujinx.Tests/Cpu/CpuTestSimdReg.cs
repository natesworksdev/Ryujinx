...
#region "ValueSource (Opcodes)"
        ...
        public void Addhn_V_8H8B_4S4H_2D2S([Values(0u)]     uint rd,
                                           ...
                                           [ValueSource(nameof(_4H2S1D_))] [Random(RndCnt)] ulong b,
        ...
        public void Sqadd_S_B_H_S_D([Values(0u)]     uint rd,
                                    ...
                                    [ValueSource(nameof(_1B1H1S1D_))] [Random(RndCnt)] ulong b,
        ...
        public void Sqdmulh_S_H_S([Values(0u)]     uint rd,
                                  [Values(1u, 0u)] uint rn,
                                  [Values(2u, 0u)] uint rm,
                                  [ValueSource(nameof(_1H1S_))] [Random(RndCnt)] ulong z,
                                  [ValueSource(nameof(_1H1S_))] [Random(RndCnt)] ulong a,
                                  [ValueSource(nameof(_1H1S_))] [Random(RndCnt)] ulong b,
        ...
        public void Sqdmulh_V_4H_2S([Values(0u)]     uint rd,
                                    [Values(1u, 0u)] uint rn,
                                    [Values(2u, 0u)] uint rm,
                                    [ValueSource(nameof(_4H2S_))] [Random(RndCnt)] ulong z,
                                    [ValueSource(nameof(_4H2S_))] [Random(RndCnt)] ulong a,
                                    [ValueSource(nameof(_4H2S_))] [Random(RndCnt)] ulong b,
        ...
        public void ShlReg_S_D([ValueSource(nameof(_ShlReg_S_D_))] uint opcodes,
                               ...
                               [ValueSource(nameof(_1D_))] [Random(RndCnt)] ulong z,
                               [ValueSource(nameof(_1D_))] [Random(RndCnt)] ulong a,
                               [ValueSource(nameof(_1D_))] [Random(0ul, 255ul, RndCnt)] ulong b)
        {
            opcodes |= ((rm & 31) << 16) | ((rn & 31) << 5) | ((rd & 31) << 0);
        ...
        public void ShlReg_V_8B_4H_2S([ValueSource(nameof(_ShlReg_V_8B_4H_2S_))] uint opcodes,
                                      ...
                                      [ValueSource(nameof(_8B4H2S_))] [Random(RndCnt)] ulong z,
                                      [ValueSource(nameof(_8B4H2S_))] [Random(RndCnt)] ulong a,
                                      [ValueSource(nameof(_8B4H2S_))] [Random(0ul, 255ul, RndCnt)] ulong b,
                                      [Values(0b00u, 0b01u, 0b10u)] uint size) // <8B, 4H, 2S>
        {
            opcodes |= ((rm & 31) << 16) | ((rn & 31) << 5) | ((rd & 31) << 0);
            opcodes |= ((size & 3) << 22);
        ...
        public void ShlReg_V_16B_8H_4S_2D([ValueSource(nameof(_ShlReg_V_16B_8H_4S_2D_))] uint opcodes,
                                          ...
                                          [ValueSource(nameof(_8B4H2S1D_))] [Random(RndCnt)] ulong z,
                                          [ValueSource(nameof(_8B4H2S1D_))] [Random(RndCnt)] ulong a,
                                          [ValueSource(nameof(_8B4H2S1D_))] [Random(0ul, 255ul, RndCnt)] ulong b,
                                          [Values(0b00u, 0b01u, 0b10u, 0b11u)] uint size) // <16B, 8H, 4S, 2D>
        {
            opcodes |= ((rm & 31) << 16) | ((rn & 31) << 5) | ((rd & 31) << 0);
            opcodes |= ((size & 3) << 22);
