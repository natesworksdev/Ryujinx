...
namespace Ryujinx.Graphics.Nvdec.FFmpeg
{
    unsafe class Surface : ISurface
    {
        ...
        public Plane YPlane => new Plane(Frame->Data[0], Stride * Height);
        public Plane UPlane => new Plane(Frame->Data[1], UvStride * UvHeight);
        public Plane VPlane => new Plane(Frame->Data[2], UvStride * UvHeight);
