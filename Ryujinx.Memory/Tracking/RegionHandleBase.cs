...
namespace Ryujinx.Memory.Tracking
{
    ...
    /// </summary>
    public abstract class RegionHandleBase : IRegionHandle, IRange
    {
        /// <summary>
        ...
        internal RegionHandleBase(MemoryTracking tracking, ulong address, ulong size, bool mapped = true)
        {
            Unmapped = !mapped;
            Address = address;
            Size = size;
        ...
        internal void Signal(ulong address, ulong size, bool write, ref IList<RegionHandleBase> handleIterable)
        {
        ...
        internal bool SignalPrecise(ulong address, ulong size, bool write, ref IList<RegionHandleBase> handleIterable)
        {
